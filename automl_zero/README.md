...
[bazel-automl_zero/external/eigen_archive/Eigen/src/Core/util/Macros.h](http://eigen.tuxfamily.org/)  Source code is authored by [Dan Hernest](mailto:hernest@rist.ro) 
